CREATE DATABASE  IF NOT EXISTS `laureldb` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci */;

USE `mysql`;
CREATE USER IF NOT EXISTS `laureluser`@`%` IDENTIFIED BY 'laurelpass';
...
INSERT INTO `page` (`id`, `name`, `stylesheet`) VALUES (1,'userpage1',NULL),(2,'userpage2',NULL),(3,'adminpage1',NULL),(4,'adminpage2',NULL),(5,'commonpage1',NULL);
...
INSERT INTO `role` (`id`, `name`, `description`) VALUES (1,'admin','Administrator'),(2,'user','Normal user'),(3,'operator','Operational user');
...
INSERT INTO `role_has_page` (`role_id`, `page_id`) VALUES (2,1),(2,2),(1,3),(1,4),(1,5),(2,5),(3,5);
...
INSERT INTO `user_has_role` (`user_id`, `role_id`) VALUES (1,1),(2,2),(1,3),(2,3);
...
-- Dump completed on 2021-03-30  0:03:27
